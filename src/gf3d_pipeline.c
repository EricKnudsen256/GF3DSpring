...
void gf3d_pipeline_wireframe_render_pass_setup(Pipeline* pipe)
{
    VkAttachmentDescription colorAttachment = { 0 };
    VkAttachmentReference colorAttachmentRef = { 0 };
    VkSubpassDescription subpass = { 0 };
...
Pipeline* gf3d_pipeline_basic_wireframe_create(VkDevice device, char* vertFile, char* fragFile, VkExtent2D extent, Uint32 descriptorCount)
{
    Pipeline* pipe;
    VkRect2D scissor = { 0 };
    VkViewport viewport = { 0 };
    ...
    gf3d_pipeline_wireframe_render_pass_setup(pipe);
...
void gf3d_pipeline_create_descriptor_sets(Pipeline *pipe)
{
    ...
    {    
        ...
        slog("allocating descriptor sets: %i", pipe->descriptorPoolCount);
...
//UBO binding here, marking for later
void gf3d_pipeline_create_basic_model_descriptor_set_layout(Pipeline *pipe)
{
